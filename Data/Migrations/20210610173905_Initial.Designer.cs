...
namespace Songs_Manager.Migrations
{
    ...
    [Migration("20210610173905_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Songs_Manager.Data.Models.Artist", b =>
                {
            ...
            modelBuilder.Entity("Songs_Manager.Data.Models.Artist_Genre", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            ArtistId = 1,
                            CreatedAt = new DateTime(2021, 6, 10, 19, 39, 4, 982, DateTimeKind.Local).AddTicks(1293),
                            GenreId = 1,
                            LastUpdatedAt = new DateTime(2021, 6, 10, 19, 39, 4, 982, DateTimeKind.Local).AddTicks(1293)
                        },
                        new
                        {
                            Id = 2,
            ...
            modelBuilder.Entity("Songs_Manager.Data.Models.Artist_Song", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Songs_Manager.Data.Models.Genre", b =>
                {
                    b.Property<int>("GenreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Songs_Manager.Data.Models.LyricsSubmissions", b =>
                {
                    b.Property<int>("LyricsSubmissionsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("LyricsSubmissionsId");

                    b.ToTable("LyricsSubmissions");
                });
            ...
            modelBuilder.Entity("Songs_Manager.Data.Models.Artist_Song", b =>
                {
                    ...
                    b.HasOne("Songs_Manager.Data.Models.Song", "Songs")
                        .WithMany("Artist_Songs")
